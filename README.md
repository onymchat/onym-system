...
| [charity/](charity/UI-Charity.md) | Charitable coordination as the first non-messaging application seat ([contract](charity/Charity.md), optional [interface attribution](charity/Attribution-Extension.md)) |
